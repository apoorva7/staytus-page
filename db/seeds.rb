...
#
Site.create!(:title => 'The Widgets Status Site', :description => 'Widgets Inc is a revolutionary widget platform. This is our status site. Contact us at team@widgetsrus.io with any questions or problems.', :domain => Rails.env.production? ? 'demo.staytus.co' : 'localhost:8080', :support_email => 'team@viaduct.io', :website_url => 'http://staytus.co', :time_zone => 'London', :http_protocol => 'http')
